...
exports.track = function(track){
  return reject(trackPayload(track, this.settings));
};
 ...
 * @return {Object} payload
 */
function trackPayload(track, settings) {
  return {
...
/**
 * Maps a page or screen call. In Calq this is a call to Track with some extra properties set.
 *
 * @param {Page} page
 * @return {Object} payload
 */
...
exports.page = function(page){
  ...
  var payload = trackPayload(page, this.settings);
  payload.action_name = page.action() == "screen" ? "Screen View" : "Page View";
...
function properties(track){
  ...
  if(track.currency) {	// Used by page() and track(), but page() won't have currency
